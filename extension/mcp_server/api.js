            ...
            async function updateEvent(eventId, calendarId, title, startDate, endDate, location, description, recurrence, recurrenceId) {
              ...
              try {
                ...
                if (recurrenceId !== undefined) {
                  ...
                  const tz = (oldItem.startDate && oldItem.startDate.timezone) || cal.dtz.defaultTimezone;
                  let recDt;
                  if (oldItem.startDate && oldItem.startDate.isDate) {
                    ...
                    recDt = cal.dtz.jsDateToDateTime(ridJs, tz);
                  }
            ...
            async function deleteEvent(eventId, calendarId, recurrenceId) {
              ...
              try {
                ...
                if (recurrenceId) {
                  ...
                  // Use the master's start timezone so the EXDATE matches the
                  // occurrence's RECURRENCE-ID generated by the rrule engine.
                  // Fallback to defaultTimezone if startDate has no timezone.
                  const tz = (item.startDate && item.startDate.timezone) || cal.dtz.defaultTimezone;
                  let recDt;
                  if (item.startDate && item.startDate.isDate) {
                    ...
                    recDt = cal.dtz.jsDateToDateTime(js, tz);
                  }
